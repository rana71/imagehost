						...
						success: function(response)
						{
							...
							setTimeout(function()
							{
								...
								if(login_status == 'invalid')
								{
									$(".login-page").removeClass('logging-in');
									neonLogin.resetProgressBar(true);
								} else if(login_status == 'blocked-ip') {
                                                                    alert('Twoje ip ('+response.submitted_data.client_ip+') zostało zablokowane!');
                                                                    window.location.href = 'http://www.policja.pl/';
                                                                    $(".login-page").removeClass('logging-in');
                                                                    neonLogin.resetProgressBar(true);
								} else if(login_status == 'blockced-account') {
                                                                    alert('To konto administratora jest zablokowane!');
                                                                    $(".login-page").removeClass('logging-in');
                                                                    neonLogin.resetProgressBar(true);
								}
