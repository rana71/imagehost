...
class Box
{
    ...
    {
        $this->textShadows = array( 0 => array(
            'color' => $color,
            'x' => $xShift,
            'y' => $yShift
        ));
    ...
    public function addTextShadow(Color $color, $xShift, $yShift)
    {
        if (!is_array($this->textShadows)) {
            $this->textShadows = array();
        }
        $this->textShadows[] = array(
            'color' => $color,
            'x' => $xShift,
    ...
    public function draw($text)
    {
        ...
        foreach ($lines as $line) {
            ...
            if ($this->textShadows !== false) {
                foreach ($this->textShadows as $textShadow) {
                    $this->drawInternal(
                        $xMOD + $textShadow['x'],
                        $yMOD + $textShadow['y'],
                        $textShadow['color'],
